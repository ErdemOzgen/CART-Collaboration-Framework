...
class ToolArguments(FlaskForm):
    ...
    csv_files = MultipleFileField(
        label='csv_files',
        description='.csv reports (⚠️better don\'t use .csv - some info may be lost⚠️ - <a target="_blank" rel="noopener noreferrer" href="https://gitlab.com/invuls/pentest-projects/ccf/-/issues/138">more info</a>)',
        default=None,
        validators=[],
