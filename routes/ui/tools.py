...
@routes.route('/project/<uuid:project_id>/tools/blackdagger-helper/', methods=['GET'])
@requires_authorization
@check_session
@check_project_access
@send_log_data
def blackdagger_helper_page(project_id, current_project, current_user):
    return render_template('project/tools/helpers/blackdagger-helper.html',
                           current_project=current_project,
                           tab_name='blackdagger Helper')
