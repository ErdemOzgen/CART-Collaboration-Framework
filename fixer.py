...
print("This is a console app to fix your ccf instance!")

print("!!! Important !!! Better to turn off your ccf instance while fixing (or just don't do anything there)")
...
try:
    ...
    print("2. Config settings.ini does not exist at ./configuration/ folder - "
          "you need to create it or copy from ccf GitLab repository")
    print("3. You run fixer.py script not from ccf repository (etc using full path to script). "
          "You need to be inside ccf folder to run it!")
    exit()
